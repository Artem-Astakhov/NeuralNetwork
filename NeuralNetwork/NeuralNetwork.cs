...
namespace NeuralNetwork
{
    public class NeuralNetwork
    {
        ...
        public Neuron FeetForward(params double[]inputSignals)
        {
            SendSignalToInputNeuron(inputSignals);
        ...
        private void FeedForwardAllLayersAfterInput()
        {
            for (int i = 1; i < Layers.Count; i++)
            {
                ...
                {
                    neuron.FeedForward(previousLayerSignal);
                }
            }
        }

        private void SendSignalToInputNeuron(params double[] inputSignals)
        {
